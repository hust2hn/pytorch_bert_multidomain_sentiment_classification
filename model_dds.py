...
class BertClassifier(nn.Module):
    ...
    def forward(self, input_id, mask):
        ...
        s_embeddings = torch.cat((d_dropout_output, s_dropout_output), 2)
        s_linear_output = self.s_linear(s_embeddings)
...
torch.save(model, 'model_dds-' + str(args.seed) + '-' + str(args.coef) + str(args.num_domain) + '-' + str(args.layer_num) + '.pth')
evaluate(model, test_custom_dataset)
